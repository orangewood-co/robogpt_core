...
class YoloV8Detection:
    ...
    def detect_objects(self, color_frame, depth_frame,serial_number):
        detection_results = {}
        i = 0
        ...
        # Object detection
        detections = self.detect(color_frame,serial_number)
    ...
    def run(self, detection_results, color_frame, depth_frame,serial_number):
        ...
        #         ii += 1
        # else:
        detection_results = self.detect_objects(color_frame, depth_frame,serial_number)
